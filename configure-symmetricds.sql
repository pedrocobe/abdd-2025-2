-- ============================================
-- Configuración de SymmetricDS para América
-- Este script configura la replicación bidireccional
-- entre PostgreSQL (América) y MySQL (Europa)
-- ============================================
...
-- 2. DEFINIR ENLACES ENTRE GRUPOS (Bidireccional - Wait for Pull)
-- W = Wait/Write - Los datos se envían cuando el nodo destino hace PULL
