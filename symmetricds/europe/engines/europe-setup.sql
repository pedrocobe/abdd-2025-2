...
-- ============================================
-- CONFIGURACIÓN DEL NODO EUROPA
-- ============================================
-- 
-- Este archivo está intencionalmente vacío.
-- 
-- La configuración completa de triggers, routers, canales y
-- vínculos de grupos de nodos se define en el nodo raíz (América)
-- y se propaga automáticamente al nodo Europa durante el registro.
--
-- SymmetricDS creará automáticamente:
-- - Las tablas sym_* necesarias en MySQL
-- - Los triggers para capturar cambios en las 4 tablas
-- - Los routers para replicación bidireccional
-- - Los canales de sincronización
--
-- No es necesario duplicar la configuración SQL aquí.
-- ============================================
